...
// import visual from '/public/images/IdVisual.png';
// import social from '/public/images/RedeSociais.png';

const servicos = [
	{img: '/images/IdVisual.png',nome:'Identidade Visual', descr:'Pacote de criação de Identidade Visual', CTA:'Quero!'},
	{img:'/images/RedeSociais.png',nome:'Redes Sociais', descr:'Um combo completo perfeito para empreendedores que se importam com suas midias sociais', CTA:'Preciso!'},
	{img:'/images/LandingPage.png',nome:'Landing Pages', descr:'Tenha uma Landing Page que atende suas necessidades', CTA:'Vamos Lá!'}
]
